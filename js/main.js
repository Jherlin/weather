...
// GET THE CONDITIONS
weatherConditions.open('GET', '//api.openweathermap.org/data/2.5/weather?zip=11226,us&appid=c166cce17d0e635e84f551ddc5bb6aa4&units=imperial', true);
...
weatherConditions.onload = function() {
    if (weatherConditions.status === 200){
        ...
        document.getElementById('temperature').innerHTML = Math.round(cObj.main.temp);
...
// GET THE FORECARST
weatherForecast.open('GET', '//api.openweathermap.org/data/2.5/forecast?zip=11226,us&appid=c166cce17d0e635e84f551ddc5bb6aa4&units=imperial', true);
...
if (weatherForecast.status === 200){
    ...
    Math.round(fObj.list[0].main.temp_min)+"&deg;";
    document.getElementById('r1c4').innerHTML =
    Math.round(fObj.list[0].main.temp_max)+"&deg;";
    ...
    Math.round(fObj.list[8].main.temp_min)+"&deg;";
    document.getElementById('r2c4').innerHTML =
    Math.round(fObj.list[8].main.temp_max)+"&deg;";
    ...
    Math.round(fObj.list[16].main.temp_min)+"&deg;";
    document.getElementById('r3c4').innerHTML =
    Math.round(fObj.list[16].main.temp_max)+"&deg;";
